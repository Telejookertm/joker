...
local function check_member_super(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text ="<b>Group name</b> : <code>"..msg.to.title.."</code>\n<b>Group has been Added by</b> : @"..msg.from.username.." !"      return reply_msg(msg.id, text, ok_cb, false)
    end
  end
end
...
local function lock_group_links(msg, data, target)
  ...
  if group_link_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Link Status switched to</b> : <code>lock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function unlock_group_links(msg, data, target)
  ...
  if group_link_lock == 'no' then
    return reply_msg(msg.id,'<b>Lock Link was on</b> : <code>unlock</code>\n<b>Status not changed !</b>', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_link'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Link Status switched to</b> : <code>UnLock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
data[tostring(target)]['settings']['lock_spam'] = 'yes'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Spam Status switched to</b> : <code>lock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function unlock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'no' then
    return reply_msg(msg.id,'<b>Lock Spam[long msg] was on</b> : <code>unlock</code>\n<b>Status not changed !</b>', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_spam'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Spam Status switched to</b> : <code>UnLock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function lock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Flood Status switched to</b> : <code>lock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function unlock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'no' then
    return reply_msg(msg.id,'<b>Lock flood was on</b> : <code>unlock</code>\n<b>Status not changed !</b>', ok_cb, false)
  else
    data[tostring(target)]['settings']['flood'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Flood Status switched to</b> : <code>UnLock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function lock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'yes' then
    return reply_msg(msg.id'Arabic is already locked', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_arabic'] = 'yes'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Arabic Status switched to</b> : <code>lock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function unlock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'no' then
    return reply_msg(msg.id,'<b>Lock Arabic was on</b> : <code>unlock</code>\n<b>Status not changed !</b>', ok_cb, false)
  else
...
local function lock_group_tag(msg, data, target)
 ...
 data[tostring(target)]['settings']['lock_tag']
  if group_tag_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Tag[ @ ] Status switched to</b> : <code>lock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function unlock_group_tag(msg, data, target)
  ...
  if group_tag_lock == 'no' then
    return reply_msg(msg.id,'<b>Lock Tag[ @ ] was on</b> : <code>unlock</code>\n<b>Status not changed !</b>', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_tag'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Tag Status switched to</b> : <code>UnLock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function lock_group_webpage(msg, data, target)
  ...
  if group_webpage_lock == 'yes' then
    return reply_msg(msg.id,'SuperGroup WebLink is already locked', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_webpage'] = 'yes'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>WebLink Status switched to</b> : <code>lock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function unlock_group_webpage(msg, data, target)
  ...
  if group_webpage_lock == 'no' then
    return reply_msg(msg.id,'<b>WebLink Status was on</b> : <code>unlock</code>\n<b>Status not changed !</b>', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_webpage'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>WebLink Status switched to</b> : <code>UnLock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function lock_group_fwd(msg, data, target)
  ...
  if group_fwd_lock == 'yes' then
    return reply_msg(msg.id,'forward is already locked', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_fwd'] = 'yes'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Forward Status switched to</b> : <code>lock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function unlock_group_fwd(msg, data, target)
  ...
  if group_fwd_lock == 'no' then
    return reply_msg(msg.id,'<b>Lock Forward was on</b> : <code>unlock</code>\n<b>Status not changed !</b>', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_fwd'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Forward Status switched to</b> : <code>UnLock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function lock_group_badw(msg, data, target)
  ...
  if group_badw_lock == 'yes' then
    return reply_msg(msg.id, 'SuperGroup badword is already locked', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_badw'] = 'yes'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>badword Status switched to</b> : <code>lock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function unlock_group_badw(msg, data, target)
  ...
  if group_badw_lock == 'no' then
    return reply_msg(msg.id, '<b>badword Status was on</b> : <code>unlock</code>\n<b>Status not changed !</b>', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_badw'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>badword Status switched to</b> : <code>UnLock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function lock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == 'yes' then
    return reply_msg(msg.id,'SuperGroup Emoji is already locked', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_emoji'] = 'yes'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Emoji Status switched to</b> : <code>lock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function unlock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == 'no' then
    return reply_msg(msg.id,'<b>Emoji Status was on</b> : <code>unlock</code>\n<b>Status not changed !</b>', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_emoji'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Emoji Status switched to</b> : <code>UnLock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function lock_group_eng(msg, data, target)
  ...
  if group_eng_lock == 'yes' then
    return reply_msg(msg.id,'SuperGroup English is already locked', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_eng'] = 'yes'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>English Status switched to</b> : <code>lock</code>\n<b>Changed by : </b>@'..  (msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function unlock_group_eng(msg, data, target)
  ...
  if group_eng_lock == 'no' then
    return reply_msg(msg.id,'<b>English Status was on</b> : <code>unlock</code>\n<b>Status not changed !</b>',  ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_eng'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>English Status switched to</b> : <code>UnLock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function lock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>RTL[Right to left PM] Status switched to</b> : <code>lock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function unlock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'no' then
    return reply_msg(msg.id,'<b>Lock RTL[Right To left Mesages] was on</b> : <code>unlock</code>\n<b>Status not changed !</b>', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_rtl'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>RTL Status switched to</b> : <code>UnLock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function lock_group_tgservice(msg, data, target)
  ...
  if group_tgservice_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>TGService[Join Group Pm] Status switched to</b> : <code>lock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function unlock_group_tgservice(msg, data, target)
  ...
  if group_tgservice_lock == 'no' then
    return reply_msg(msg.id,'<b>Lock TGservice[Join Group Pm] was on</b> : <code>unlock</code>\n<b>Status not changed !</b>', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_tgservice'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>TGService Status switched to</b> : <code>UnLock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function lock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Sticker Status switched to</b> : <code>lock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function unlock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'no' then
    return reply_msg(msg.id,'<b>Lock Sticker was on</b> : <code>unlock</code>\n<b>Status not changed !</b>', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_sticker'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Sticker Status switched to</b> : <code>UnLock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function lock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Contact Status switched to</b> : <code>lock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
local function unlock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'no' then
    return reply_msg(msg.id,'<b>Lock Contact was on</b> : <code>unlock</code>\n<b>Status not changed !</b>', ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_contacts'] = 'no'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,'<b>Contact Status switched to</b> : <code>UnLock</code>\n<b>Changed by : </b>@'..(msg.from.username or msg.from.first_name), ok_cb, false)
  end
end
...
, ok_cb, false)		end
		...
		if matches[1] == 'joker' and is_admin1(msg)then
			text = msg.to.peer_id
			reply_msg(msg.id, text, ok_cb, false)

...
local function pre_process(msg)
	...
	if expiretime then    
		...
		rem_mutes(msg.to.id)
		superrem2(msg)
		return send_large_msg(get_receiver(msg), 'تاریخ اتقضاء گروه به پایان رسید.\n از پشتیبانی در خواست تمدید کنید.[ @Mrjooker ] \n اگر ریپورت هستید به ربات ما مراجعه کنید [ @Joker_testi_bot ]')
		else
			return
		end
	end
